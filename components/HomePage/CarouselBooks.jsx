...
export function CarouselBooks({ featuredBooks }) {
    return (
            ...
            {Array.from({ length: 8 }).map((_, index) => (
                ...
                <div className="group cursor-pointer">
                    ...
                    <CardContent className="p-0">
                        ...
                        {/* The Book Cover */}
                        <div className="aspect-[3/4] rounded-t-xl bg-slate-100 flex items-center justify-center border border-slate-200 transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-2">
